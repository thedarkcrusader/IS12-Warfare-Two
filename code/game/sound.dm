...
GLOBAL_LIST_INIT(mil_rustle_sound,list('sound/effects/mil_rustle1.ogg','sound/effects/mil_rustle2.ogg','sound/effects/mil_rustle3.ogg'))
GLOBAL_LIST_INIT(mil_rustle_sound_l,list('sound/effects/mil_rustle_l1.ogg','sound/effects/mil_rustle_l2.ogg'))
GLOBAL_LIST_INIT(mil_rustle_sound_l_c,list('sound/effects/mil_rustle_lc1.ogg','sound/effects/mil_rustle_l2.ogg'))
GLOBAL_LIST_INIT(generic_rustle, list('sound/effects/wearcloth_new1.ogg','sound/effects/wearcloth_new2.ogg','sound/effects/wearcloth_new3.ogg'))
GLOBAL_LIST_INIT(arm,list('sound/effects/pin1.ogg','sound/effects/pin2.ogg'))
GLOBAL_LIST_INIT(mil_drop,list('sound/effects/bag_drop_1.ogg','sound/effects/bag_drop_2.ogg'))
GLOBAL_LIST_INIT(combust,list('sound/weapons/guns/fire/flame1.ogg','sound/weapons/guns/fire/flame2.ogg','sound/weapons/guns/fire/flame3.ogg','sound/weapons/guns/fire/flame4.ogg','sound/weapons/guns/fire/flame5.ogg'))
GLOBAL_LIST_INIT(flamer_fire, list('sound/weapons/guns/fire/flamer_fire1.ogg', 'sound/weapons/guns/fire/flamer_fire2.ogg'))
...
GLOBAL_LIST_INIT(bayonet_stab, list('sound/weapons/bayostab1.ogg','sound/weapons/bayostab2.ogg','sound/weapons/bayostab3.ogg'))
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("military_rustle") soundin = pick(GLOB.mil_rustle_sound)
			if ("military_rustle_light") soundin = pick(GLOB.mil_rustle_sound_l)
			if ("military_rustle_light_close") soundin = pick(GLOB.mil_rustle_sound_l_c)
			if ("rustle_new") soundin = pick(GLOB.generic_rustle)
			if ("arm") soundin = pick(GLOB.arm)
			if ("combust") soundin = pick(GLOB.combust)
			if ("flamer_fire") soundin = pick(GLOB.flamer_fire)
			if ("military_drop") soundin = pick(GLOB.mil_drop)
			...
			if ("bayonet_stab") soundin = pick(GLOB.bayonet_stab)
